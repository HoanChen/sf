        ...
        <div class="top-c-box">
          ...
          <div class="top-c-content">
            ...
            <div class="addresstime">
              <span>2小时15分钟</span>
              <img src="../assets/image/timejiantou.png">
            </div>
          </div>
          <div class="font24 mar_t20">
            <div class="mar_b15">
              <span class="color-61">机建/税费 经济仓</span>
              <span class="float-r">午餐</span>
            </div>
            <div>
              <span class="color-f4">￥50/￥30 8.4折/￥999</span>
              <span class="float-r color108">退改签说明</span>
            </div>
          </div>
        </div>
      </div>
